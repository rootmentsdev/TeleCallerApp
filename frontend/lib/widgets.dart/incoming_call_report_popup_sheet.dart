...
/// Popup sheet for incoming call with report (completed) lead details
/// Shows lead information in a bottom sheet with editable remarks field
class IncomingCallReportPopupSheet extends StatefulWidget {
  final LeadModel lead;
  final int? callDuration;
  final Function(String remarks) onSave;

  const IncomingCallReportPopupSheet({
    super.key,
    required this.lead,
    this.callDuration,
  ...
  @override
  State<IncomingCallReportPopupSheet> createState() =>
      _IncomingCallReportPopupSheetState();
}

class _IncomingCallReportPopupSheetState
    extends State<IncomingCallReportPopupSheet> {
  ...
  String _formatLeadType(String? leadType) {
    if (leadType == null) return 'Report';
